...
char DF_STATIC_OBJECT_BUFFER[33];
#define DF_STATIC_OBJECT_BUFFER_LENGTH 32

char DF_STATIC_DATE_BUFFER[129];
#define DF_STATIC_DATE_BUFFER_LENGTH 128

long DF_STATIC_RETURN_POINTER;


#define DF_DEFAULT_FLOAT_FORMAT "%g"
#define DF_DEFAULT_RETURN_POINTER (int*)DF_STATIC_RETURN_POINTER
